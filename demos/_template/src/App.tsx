...
// Point de départ. L'agent remplace tout ceci par la démo demandée.
// Tout est isolé dans ce dossier : ce composant, le CSS, les données.
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-[#0a0a0f] text-white">
      ...
      <div className="pointer-events-none absolute inset-0 z-10 flex flex-col items-center justify-center gap-6 px-6 text-center">
        ...
        >
          Template · React + Three.js + Tailwind
        </motion.span>
        <motion.h1
        ...
        >
          Ton point de départ. Tout vit dans ce dossier : code, CSS, données.
          Construis, screenshote, expédie. 🎉
        </motion.p>
      </div>
    </div>
  )
